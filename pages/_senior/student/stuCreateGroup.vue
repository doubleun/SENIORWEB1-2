<template>
  <div>
    ...
    <v-divider></v-divider> -->
    <StudentCreateGroupForm :groupMembers="groupMembers" @refresh="refresh" />
    <!-- <GroupInvitationCard /> -->
  </div>
</template>
<script>
...
export default {
  ...
  methods: {
    refresh() {
      // await this.$store.dispatch('group/storeGroupMembers')
      // this.groupMembers = this.$store.state.group.currentUserGroupMembers
      this.$nuxt.refresh()
    }
  }
}
