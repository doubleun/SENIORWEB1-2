...
addoneUser = async (req, res) => {
  ...
  var sql =
    "INSERT INTO `users` ( `User_Identity_ID`, `User_Name`, `User_Email`, `User_Phone`, `User_Role`, `Major_ID`) Select ?,?,?,?,?,?,? Where not exists(select `User_ID`, `User_Identity_ID`, `User_Name`, `User_Email`, `User_Phone`, `User_Role`, `Major_ID` from users where User_Email= ?);";
