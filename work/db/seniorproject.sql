...
('wachirachai.n@appman.co.th', '6131501055', 'Test admin', 99, '1302492', 1, 15);
...
--
ALTER TABLE `evalcomment`
  MODIFY `Eval_Comment_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `scorecriterias`
  MODIFY `Score_criteria_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
